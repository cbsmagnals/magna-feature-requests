...
const FeatureRequestDemo = () => {
  ...
  return (
    <div className="space-y-6 p-4">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl">Magna Legal Services Feature Request Tool</CardTitle>
          <p className="text-gray-600 mt-1">Streamline and prioritize feature requests for Magna Legal Services products</p>
        </CardHeader>
        <CardContent>
